...
def callsm(img_base64):
    ...
    res = client.invoke_endpoint(EndpointName='jumpstart-ftd-mobilenet-v2-100-224-classification-4', ContentType='application/x-image',Body=data, Accept='application/json;verbose')
